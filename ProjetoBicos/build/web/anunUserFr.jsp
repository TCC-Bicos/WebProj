...
<html Lang="pt">
    ...
    <body>
        ...
        <%
            String nome,email,idAnun,nomeUser,emailUser;
            SistemaDao dao;
            Tblusuario user;
            int idUser;
            ...
            idUser = anunUser.getIdUser().getIdUser();

            //Buscar dados do usuário (autor do anúncio)
            user = dao.buscarUserId(idUser);
        ...
        <main>
            ...
            <div class="d-flex anun">
                ...
                <div class="col-7 d-flex name">
                    <div class="title">
                        <h1> <%=nomeAnun%> </h1>
                        <a href="profileUserFr.jsp?nome=<%=nome%>&email=<%=email%>&nomeUser=<%=nomeUser%>&emailUser=<%=emailUser%>"> <%=nomeUser%> </a>
                        <h3> <%=precoAnun%> </h3>
                        <a href="criarProjUserFr.jsp?id=<%= anunUser.getIdAnunUser() %>&nome=<%= fr.getNomeFr() %>&email=<%= fr.getEmailFr() %>">
